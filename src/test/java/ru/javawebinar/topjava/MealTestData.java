...
public class MealTestData {
    ...
    public static final List<UserMealWithExceed> USER_MEALS_WITH_EXCEED = UserMealsUtil.getWithExceeded(USER_MEALS, UserMealsUtil.DEFAULT_CALORIES_PER_DAY);


    public static UserMeal getCreated() {
        return new UserMeal(null, of(2020, Month.JUNE, 1, 18, 0), "Созданный ужин", 300);
    }
